...
export interface LiveQuizMetric {
  label: string;
  value: string;
  hint?: string;
  icon?: ReactNode;
...
export interface LiveQuizRankEntry {
  id: string;
  rank: number;
  name: string;
  code?: string | null;
...
interface LiveQuizLeaderboardProps {
  metrics: LiveQuizMetric[];
  leaderboard: LiveQuizRankEntry[];
  progressRows: LiveQuizRankEntry[];
  podiumTitle?: string;
...
function QuizMetricStrip({ metrics }: { metrics: LiveQuizMetric[] }) {
  return (
...
function QuizPodium({ entries, title }: { entries: LiveQuizRankEntry[]; title: string }) {
...
function PodiumSlot({ entry, rank }: { entry?: LiveQuizRankEntry; rank: number }) {
...
function ProgressRow({ row }: { row: LiveQuizRankEntry }) {
...
function supportingText(entry: LiveQuizRankEntry) {
...
function progressPercent(entry: LiveQuizRankEntry) {
