...
public class SecurityConfig {
    ...
    private final ExamRuntimeHeaderAuthenticationFilter examRuntimeAuthenticationFilter;
    private final InternalApiKeyAuthenticationFilter internalApiKeyAuthenticationFilter;

    public SecurityConfig(
            ExamRuntimeHeaderAuthenticationFilter examRuntimeAuthenticationFilter,
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.cors(cors -> cors.configurationSource(request -> {
                ...
                .authorizeHttpRequests(request -> request
                        .requestMatchers("/v1/api/examruntime-service/public/**").permitAll()
    ...
    @Bean
    public FilterRegistrationBean<ExamRuntimeHeaderAuthenticationFilter> questionHeaderFilterRegistration(
            ExamRuntimeHeaderAuthenticationFilter filter
    ) {
        FilterRegistrationBean<ExamRuntimeHeaderAuthenticationFilter> registration =
