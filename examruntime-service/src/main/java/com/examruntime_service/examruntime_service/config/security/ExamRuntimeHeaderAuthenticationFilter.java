 ...
 */
public class ExamRuntimeHeaderAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void createAuthentication(HttpServletRequest request) {
        ...
        ExamRuntimeUserPrincipal principal = new ExamRuntimeUserPrincipal(userId, username, role);
