...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, String> examRuntimeProducerFactory(
    ...
    public KafkaTemplate<String, String> kafkaTemplate(
            ProducerFactory<String, String> examRuntimeProducerFactory
    ) {
        return new KafkaTemplate<>(examRuntimeProducerFactory);
    }
